...
import { useGetMyVacancyQuery } from "../../../app/services/vacancyApi"
                    ...
                    <div className={classes.vacancy_info}>
                        <div className={classes.vacancy_top}>
                            ...
                            <div className={classes.btn_box}>
                                <a className={classes.btn_tall} href={vacancy.data?.vacancy?.employer?.info?.socials.find((social: any) => social.type === 'official').url}
                                ...
                                <div className={classes.content_item}>
                                    ...
                                    <div className={classes.skills_container}>
                                        {vacancy.data?.vacancy?.licenseCategories.map((skill: any) => (
                                            <div className={classes.license_item}>
                                                {skill.code}
                                            </div>
                                        ))}
                                    </div>
